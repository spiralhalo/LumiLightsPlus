...
const float USER_SUNLIGHT_MULTIPLIER       = clamp(SUNLIGHT_BOOST, 0.25, 3.0);
...
// ******************************
	...
	#define DEF_EMISSIVE_LIGHT_STR	40.0
	...
	#define DEF_SUNLIGHT_STR		1.5 * USER_SUNLIGHT_MULTIPLIER
	#define DEF_NOON_AMBIENT_STR	0.8 * USER_NOON_AMBIENT_MULTIPLIER
#else
	#define SUN_AMBIENT_MULT		(USER_SUNLIGHT_MULTIPLIER + USER_NOON_AMBIENT_MULTIPLIER) * 0.5
	#define DEF_SUNLIGHT_STR		0.8 * SUN_AMBIENT_MULT
	#define DEF_NOON_AMBIENT_STR	0.8 * SUN_AMBIENT_MULT
#endif
	#define DEF_SKY_STR				0.5
	#define DEF_NIGHT_AMBIENT_STR	0.1 * USER_NIGHT_AMBIENT_MULTIPLIER
	#define DEF_MOONLIGHT_RAW_STR	0.2
	...
	const vec3 SKYLESS_LIGHT_COLOR		= vec3(0.6, 1.0, 0.8);
