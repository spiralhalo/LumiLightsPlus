...
// IMPORTANT: These configurations are ignored if Respackopts is present.
...
#define LUMIEXT_EnablePBRExtB       1    // | Global toggle for Lumi PBR Ext      |  0: Disable, 1: Enable                |  1      |
//________________________________|_________|_____________________________________|_______________________________________|_________|
...
#define LUMIEXT_TextureResolution   64   // | Bump map resolution                 |  16~2048                              |  64     |
//________________________________|_________|_____________________________________|_______________________________________|_________|
...
#define LUMIEXT_WoodPlanksRoughness 6    // | Roughness of wood planks            |  1~10                                 |  6      |
//________________________________|_________|_____________________________________|_______________________________________|_________|
